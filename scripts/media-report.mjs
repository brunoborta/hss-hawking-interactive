// Lists POIs without a public/media/pics/<id>.webp and images without a POI.
// New raw captures go in tools/source/pics-raw/<id>.png, then `npm run pics:process`.
...
for (const id of orphans) console.log(`  - ${id}.webp`);
